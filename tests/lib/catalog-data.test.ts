  ...
  it('defines the exact EGDS framework topology and relations', () => {
    ...
    expect(
      ...
      [
        ...
        1,
        '体验形态与观察尺度',
        'Experience Form and Observation Scales',
      ],
      ['perception', 'stage', 'experience-design', 2, '感知', 'Perception'],
      ['rationalization', 'stage', 'experience-design', 3, '理解', 'Understanding'],
      ['deconstruction', 'stage', 'experience-design', 4, '归因', 'Attribution'],
      ['reconstruction', 'stage', 'experience-design', 5, '重构', 'Reconstruction'],
      ['narrative-lever', 'lever', 'reconstruction', 1, '叙事', 'Narrative'],
      ['aesthetics-lever', 'lever', 'reconstruction', 2, '美学', 'Aesthetics'],
      [
