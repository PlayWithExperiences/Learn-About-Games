...
export const historyRoutes = [
  {
    id: "mobile",
    title: "游戏装进口袋，玩法怎样改变？",
    text: "掌机移植、按键手机、手指划动与现实位置各有不同约束。这是跨品类的平台比较；只有有来源的作品关系才连线，不把所有移动游戏写成同一谱系。",
    ids: ["tetris", "tetris-game-boy", "snake-nokia", "angry-birds", "angry-birds-reloaded", "fruit-ninja", "fruit-ninja-hd-2012", "shared-touch-play", "monument-valley", "ingress", "pokemon-go"],
  },
  {
    id: "practice",
    title: "技巧，怎样变得可学可练？",
    text: "比较格斗的操作门槛、赛车的练习反馈与体感的动作精度。点选查看每条变化的依据；同属练习问题并不表示互相影响。",
    ids: ["street-fighter-ii", "virtua-fighter", "virtua-fighter-2", "virtua-fighter-4", "tekken", "street-fighter-6", "virtua-racing", "daytona-usa", "trackmania", "gran-turismo", "gran-turismo-7", "gt7-spec-iii", "driving-data-feedback", "wii-sports", "wii-sports-resort"],
  },
  {
    id: "mods",
  ...
  },
  {
    ...
    ids: ["dance-dance-revolution", "frequency", "amplitude-2003", "guitar-hero", "rock-band", "ensemble-performance", "super-beat-sports"],
  },
  {
    id: "runs",
    title: "失败之后，什么留下来？",
  ...
  },
  {
    ...
    ids: [
      ...
      "outer-wilds",
      "monument-valley",
      "three-dimensional-goal-guidance",
      "curiosity-in-changing-world",
      "ultima",
      "jx3-yidai-zongshi",
      "genshin-impact",
      "grand-theft-auto",
