...
- 成长资源改为 15 个默认收起、可独立展开的主题子表，并提供展开全表／全部收起；七维筛选会自动打开有匹配结果的组。29 个 Source 进入独立目录，148 个 Work Item、161 个 Access Version 与 12 条外部观察保持完整；构建期强制每个 Work Item 恰属一个主要资源主题。本轮新增 20 项课程、论文、网站、文章、播客与书籍，优先补低覆盖主题和两项此前零直接资源的能力，不添加站内评分。
