...
- Innovation Atlas 改为“创新事件 → 承载作品”的阅读入口：网络新增第一人称射击视角、锁定目标的空间战斗、角色成长、开放世界非线性探索与程序生成单局结构等事件节点，并以 64 个节点、46 条关系、73 项 Evidence 保持证据闭包。事件说明发生了什么和由哪些作品承载，不宣称唯一发明者；Genre Family 继续作为非排他的浏览入口。
