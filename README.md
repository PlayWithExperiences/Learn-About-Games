...
- 独立的 [EGDS 方法介绍页](src/pages/egds/index.astro) 说明能力地图采用的作者方法基础。正文以 PlayWithExperiences Digital Garden 的当前工作模型为先，区分情绪曲线 → 情绪体验 → 主观感受 → 客观原因 → 设计杠杆的因果链，以及感知 → 理解 → 解构 → 重构的工作循环；2024 年四篇已发布文章作为真实演进记录保留。
