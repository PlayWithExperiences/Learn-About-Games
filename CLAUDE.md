...
The repository is PRIVATE during product refinement, the previously public GitHub Pages site returns 404, and `.github/workflows/deploy.yml` is manually disabled. Do not describe the site as currently deployed or public. Private refinement runtime `1a1e2d132e7bcd28fa3b4418c1ac23ed5b7d1d7a` is pushed to remote `codex/v02`, passed the local acceptance suite and is waiting for the user's private review. Runtime HEAD `0b6bfb462f7b697ac526a9c6bf48a95878ed642a` and Pages run `31282275108` remain historical evidence of the last verified public build. Continue from the v0.2 specification and `DESIGN.md`; do not reintroduce site-authored resource quality tiers or mandatory learning paths.

Read the [EGDS Expertise Map redesign](docs/superpowers/specs/2026-08-09-egds-expertise-map-design.md), the [private refinement design](docs/superpowers/specs/2026-08-09-private-refinement-design.md), the linked v0.2 product design, [DESIGN.md](DESIGN.md), [ROADMAP.md](ROADMAP.md), and [CHANGELOG.md](CHANGELOG.md) before implementation. Open the conversation record only when the summary and design do not preserve enough context. Update both journal artifacts at substantive milestones; update the public Roadmap, Changelog and Devlog when project direction or shipped behavior changes.
